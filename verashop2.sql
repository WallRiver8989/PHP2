...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2019 at 01:48 AM
...
CREATE TABLE `orders` (
  `ID` int(11) NOT NULL,
  `CostomerName` varchar(500) NOT NULL,
  `CostomerAddress` int(11) NOT NULL,
  `CostomerPhone` varchar(500) NOT NULL,
  `CostomerMail` varchar(500) NOT NULL,
...
INSERT INTO `orders` (`ID`, `CostomerName`, `CostomerAddress`, `CostomerPhone`, `CostomerMail`, `PaymentMethod`, `PaymentStatus`, `CreateDate`, `CreateBy`, `Status`, `Message`) VALUES
(1, 'hai', 0, '123', 'asdf@gmail.com', NULL, NULL, NULL, NULL, b'0', 'qwe'),
(2, 'hai', 0, '123', 'asdf@gmail.com', NULL, NULL, NULL, NULL, b'0', 'qwe');
...
(1, 'Samsung Galaxy S10', 0, 1, 'galaxy-s9.png', '130.00', '10.00', NULL, '    ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'1', NULL, 12, '120.00', NULL),
(2, 'Iphone S11', 0, 1, 'iphone-6-16GB-250x300.png', '100.00', '5.00', NULL, '  ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'1', NULL, 12, '140.00', NULL),
(4, 'SamSung Bung Bung', 0, 2, 'sony-experia.jpg', '200.00', '12.00', NULL, ' ', NULL, NULL, b'1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'1', NULL, 20, '100.00', NULL),
(5, 'Dell teo teo', 0, 2, 'oppo-f1-plus-14-250x300.png', '20.00', '17.00', NULL, '   ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'1', NULL, 21, '10.00', NULL),
(6, 'HP tê tê', 0, 2, 'asus zenfone.png', '200.00', '20.00', NULL, ' ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'1', NULL, 21, '100.00', NULL),
(7, 'Xiaomi ti ti ', 0, 2, 'iPad Pro 12.9 inch 64GB.jpg', '200.00', '40.00', NULL, ' ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'1', NULL, 20, '100.00', NULL),
(8, 'Lenovo dô dô', 0, 2, 'iphone-6-16GB-250x300.png', '200.00', '15.00', NULL, ' ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'1', NULL, 20, '100.00', NULL);
